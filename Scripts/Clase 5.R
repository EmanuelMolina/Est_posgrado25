...
# Los datos deben tener una distribución normal y presentar homogeneidad de varianzas 
...
boxplot(DAP ~ Paraje, data = localidad,
        main = "Boxplot de DAP por Paraje",
        xlab = "Paraje",
        ylab = "DAP",
        col = "lightblue")
...
# Se indica Dap_log a la nueva columna que se va a crear y contendrá los datos transformado
